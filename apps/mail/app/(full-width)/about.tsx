...
const sections = [
  {
    ...
    content: (
      <p>
        Skippy is an AI-powered email client that manages your inbox, so you don't have to. We help
  ...
  },
  {
    ...
    content: (
      <p>
        We started Skippy because we were frustrated that email — the most-used communication tool in
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Skippy is built on the principles of transparency and community collaboration. Our entire
        ...
        <ul className="ml-4 list-disc space-y-2">
          ...
          <li>Self-host their own instance of Skippy</li>
        ...
        <p>
          ...
          source, we ensure that Skippy remains transparent, trustworthy, and accessible to everyone.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          it manually. Skippy is poised to fundamentally change the way the world deals with
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Adam and Nizar, the cofounders of Skippy, met through family friends. Coming from
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <p>Want to learn more about Skippy? Get in touch:</p>
