...
const steps = [
  ...
  },
  {
    ...
    description: 'Skippy allows you to chat with your inbox, and take actions on your behalf.',
  ...
  },
  {
    ...
    description: 'Skippy helps you label your emails to focus on what matters.',
