...
export function AIChat({
  ...
  const editor = useComposeEditor({
    placeholder: 'Ask Skippy to do anything...',
          ...
          {chatMessages && !chatMessages.enabled ? (
            ...
            >
              <TextShimmer className="text-center text-xl font-medium">
                Upgrade to Skippy Pro for unlimited AI chat
              </TextShimmer>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <div className="relative mb-4 h-[44px] w-[44px]">
                <img src="/black-icon.svg" alt="Skippy Logo" className="dark:hidden" />
                <img src="/white-icon.svg" alt="Skippy Logo" className="hidden dark:block" />
              </div>
